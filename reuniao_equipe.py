...
class ReuniaoEquipeApp:
    ...
    def load_agents(self):
        ...
        for root, dirs, files in os.walk(self.base_dir):
            if any(x in root for x in [".gemini", ".git", ".venv", "skills"]): continue
            for file in files:
    ...
    def load_skills(self):
        ...
        skills_path = os.path.join(self.base_dir, "skills")
    ...
    def add_item_dialog(self):
        ...
        def create():
            ...
            if is_agent:
                target = os.path.join(self.base_dir, f"{slug}.agent.md")
                content = f'---\nname: "{data["Nome"]}"\ndescription: "{data["Descrição"]}"\n---\n\n# {data["Nome"]}\n\n## Persona\n\n{data["Persona"]}\n\n## Principles\n\n{data["Principles"]}\n\n## Operational Framework\n\n{data["Operational Framework"]}\n'
            else:
                dir_path = os.path.join(self.base_dir, "skills", slug)
