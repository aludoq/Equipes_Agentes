...
Esta squad é especializada em inteligência de abastecimento e gestão de estoque para redes de varejo. Ela orquestra múltiplos agentes para garantir que as lojas tenham o produto certo, na gountidade certa, minimizando rupturas e excessos de estoque.
...
- **📦 Davi Depósito (Logística de Loja):** Otimiza o espaço físico. Identifica sobras no depósito da loja para evitar pedidos desnecessários ao CD.
- **🌤️ Clara Clima (Inteligência Sazonal):** Ajusta o OTB (Open-to-Buy) com base em previsões climáticas e histórico promocional.
- **🛒 Caio Compras (Gestor do CD):** Responsável pelo "Estoque Pulmão" no **Centro de Distribuição (Filial 15)**. Garante cobertura de 15 dias para a rede, comprando de fornecedores externos em fardos/caixas.
- **📊 Diego Dashboard (Relator Executivo):** Consolida os dados em KPIs estratégicos e alertas de ação para a diretoria.
