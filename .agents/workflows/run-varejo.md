...
3. **Refinamento Estético e Fisico (Gabi e Davi):** Revise as quantidades propostas para garantir Facing na Gôndola e que compras não dupliquem sobra de retaguarda (buscando as regras em seus respectivos `.agent.md`).
...
5. **Finalização C-Level (Diego Dashboard):** Condense o Output inteiro em `07-dashboard-aprovado.md` salvo na `bd_saida` focado nos pilares Financeiros C-Level e Action Items (`diego-dashboard.agent.md`).
