...
4. **Foco no CD**: Lembre-se sempre: Filial 015 é o Centro de Distribuição (CD).
...
4. **Aplicação do Glossário**: Identifique a Filial 015 e marque-a explicitamente como Centro de Distribuição nos relatórios.
